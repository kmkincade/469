...
def get_partition_tables(f):
    ...
    partition_tables = [partition_tables[i*32:i*32+32] for i in xrange(4)]
    ...
    partition_tables = map(lambda x: [x[i*2:i*2+2] for i in xrange(16)], partition_tables) # Now looks like [['00', '20', '21', '00', '0b', '55', '11', '04', '00', '08', '00', '00', '00', '08', '01', '00']]
